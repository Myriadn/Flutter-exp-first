...
var tourismPlaceList = [
  TourismPlace(
    name: 'Kebun Mas Agung',
    location: 'Lembang',
    description:
        'Kebun Mas Agung adalah tempat wisata di Bandung yang cocok untuk berlibur bersama keluarga. Tempat ini menawarkan berbagai macam fasilitas yang bisa dinikmati oleh pengunjung. Mulai dari bermain air, bermain outbound, hingga bermain dengan rusa yang ada di kebun ini. Kebun Mas Agung juga memiliki fasilitas penginapan yang bisa digunakan oleh pengunjung yang ingin menginap di tempat ini. Penginapan yang disediakan oleh Kebun Mas Agung ini memiliki desain yang unik dan menarik. Penginapan ini juga dilengkapi dengan fasilitas yang memadai, sehingga pengunjung akan merasa nyaman saat menginap di tempat ini.',
    openDays: 'Open Everyday',
    openTime: '09:00 - 20:00',
    ticketPrice: 'Di kondisikan',
  ...
  TourismPlace(
    name: 'Teleskop Mas Wijaya Kusuma',
    location: 'Lembang',
    description:
        'Teleskop Mas Wijaya Kusuma adalah tempat wisata di Bandung yang cocok untuk berlibur bersama keluarga. Tempat ini menawarkan berbagai macam fasilitas yang bisa dinikmati oleh pengunjung. Mulai dari bermain air, bermain outbound, hingga bermain dengan rusa yang ada di kebun ini. Kebun Mas Agung juga memiliki fasilitas penginapan yang bisa digunakan oleh pengunjung yang ingin menginap di tempat ini. Penginapan yang disediakan oleh Kebun Mas Agung ini memiliki des',
